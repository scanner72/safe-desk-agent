...
Using last 102,450, stop 100,200 (~1.2× ATR under the last higher low), TP 106,950 (about 2R). Risk cap stays 1%.

```
python -m safe_desk ticket \
  --symbol BTCUSDT --side BUY \
  --equity 1000 --entry 102450 --stop 100200 --tp 106950 \
  --rationale "Daily SMA stack BULL, ATR NORMAL, stop ~1.2x ATR"
```
...
Notional     455.50
R:R          2.00
Rationale    Daily close holds above SMA20/SMA50. ATR% is NORMAL. Stop sits about 1.2× ATR under the last swing.
